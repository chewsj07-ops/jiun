...
export function PrivacyPolicy({ onBack }: LegalProps) {
  return (
    <div className="min-h-screen bg-zen-bg text-zen-ink font-sans p-6 md:p-12 max-w-4xl mx-auto">
      <button 
        onClick={onBack}
        className="flex items-center gap-2 text-zen-accent hover:opacity-80 transition-opacity mb-8"
      >
        <ArrowLeft className="w-5 h-5" />
        Back to App
      </button>
      
      <h1 className="text-3xl font-serif font-bold mb-6 text-zen-accent">Privacy Policy (隐私政策)</h1>
      <div className="prose prose-stone max-w-none text-zen-ink/80 space-y-4">
        <p className="text-sm text-zen-accent/60">Last Updated (最后更新): 2026-03-11</p>
        ...
        <h3 className="text-lg font-bold text-zen-ink mt-6 mb-2">1. Information We Collect (我们收集的信息)</h3>
        <h4 className="text-base font-bold text-zen-ink mt-4 mb-1">Account Information (账户信息)</h4>
        ...
        <h4 className="text-base font-bold text-zen-ink mt-4 mb-1">User Content (用户内容)</h4>
        ...
        <h4 className="text-base font-bold text-zen-ink mt-4 mb-1">Technical Information (技术信息)</h4>
        ...
        <h3 className="text-lg font-bold text-zen-ink mt-6 mb-2">2. How We Use Information (我们如何使用信息)</h3>
        ...
        <h3 className="text-lg font-bold text-zen-ink mt-6 mb-2">3. AI Processing (AI 处理)</h3>
        ...
        <h3 className="text-lg font-bold text-zen-ink mt-6 mb-2">4. Data Ownership (数据所有权)</h3>
        ...
        <h3 className="text-lg font-bold text-zen-ink mt-6 mb-2">5. Data Security (数据安全)</h3>
        ...
        <h3 className="text-lg font-bold text-zen-ink mt-6 mb-2">6. Backup Protection (备份保护)</h3>
        ...
        <h3 className="text-lg font-bold text-zen-ink mt-6 mb-2">7. Data Sharing (数据共享)</h3>
        ...
        <h3 className="text-lg font-bold text-zen-ink mt-6 mb-2">8. Children (儿童)</h3>
        ...
        <h3 className="text-lg font-bold text-zen-ink mt-6 mb-2">9. International Transfer (国际传输)</h3>
        ...
        <h3 className="text-lg font-bold text-zen-ink mt-6 mb-2">10. Your Rights (您的权利)</h3>
        ...
        <h3 className="text-lg font-bold text-zen-ink mt-6 mb-2">11. Policy Updates (政策更新)</h3>
        <p>We may update this policy. (我们可能更新本政策。)</p>
        <p>Major changes will be notified to users through the app. (重大变更将通过应用通知用户。)</p>

        <h3 className="text-lg font-bold text-zen-ink mt-6 mb-2">12. Contact (联系我们)</h3>
        <p><a href="mailto:vowzen91@gmail.com" className="text-zen-accent hover:underline">vowzen91@gmail.com</a></p>

        <div className="mt-8 p-6 bg-zen-bg/50 rounded-2xl border border-zen-accent/10">
        ...
        <div className="mt-4 p-6 bg-zen-bg/50 rounded-2xl border border-zen-accent/10">
...
export function TermsOfService({ onBack }: LegalProps) {
  return (
    <div className="min-h-screen bg-zen-bg text-zen-ink font-sans p-6 md:p-12 max-w-4xl mx-auto">
      ...
      <h1 className="text-3xl font-serif font-bold mb-6 text-zen-accent">Terms of Service (使用条款)</h1>
      <div className="prose prose-stone max-w-none text-zen-ink/80 space-y-4">
        <p className="text-sm text-zen-accent/60">Last Updated (最后更新): 2026-03-11</p>

        <h3 className="text-lg font-bold text-zen-ink mt-6 mb-2">1. Acceptance (接受条款)</h3>
        <p>By using ZenAssistant, you agree to these terms. (使用 ZenAssistant 即表示您同意本条款。)</p>

        <h3 className="text-lg font-bold text-zen-ink mt-6 mb-2">2. Service Description (服务描述)</h3>
        ...
        <h3 className="text-lg font-bold text-zen-ink mt-6 mb-2">3. User Responsibility (用户责任)</h3>
        <p>Users must (用户需):</p>
        <ul className="list-disc pl-5 space-y-1">
        ...
        <h3 className="text-lg font-bold text-zen-ink mt-6 mb-2">4. User Content (用户内容)</h3>
